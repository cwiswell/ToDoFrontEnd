...
const toDoList: ToDoList = { title: "Monday ToDo List", toDoItems: toDoData, active: true, id: 1, dateCreated: new Date(), lastUpdated: new Date() };
const prevToDoList: ToDoList = { title: "Sunday To Do List", toDoItems: prevToDoData, active: false, id: 5, dateCreated: new Date(), lastUpdated: new Date() };

export function GetActiveToDos(): Promise<ToDoList[] | null> {
    return new Promise<ToDoList[] | null>((resolve, reject) => {
        let data: ToDoList[] = [
            toDoList, 
            { title: "Other list", toDoItems: toDoData, active: true, id: 2, dateCreated: new Date(), lastUpdated: new Date() }, 
            { title: "Weekly To Dos", toDoItems: toDoData, active: true, id: 3, dateCreated: new Date(), lastUpdated: new Date() }];
        resolve(data);
    });
}
